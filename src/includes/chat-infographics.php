<div class="section circle contact">
    <div class="w-layout-grid grid-chat">
        ...
        <div data-react-id="chat" data-react-type="trigger-target" data-react-center="true" id="w-node-2a8cb55ea673-b55ea66f" class="chat-wrapper">
            ...
            <div id="w-node-f68b61013def-b55ea66f" class="chat-message">
                <div class="before-spinner">
                    <p><strong>Birger</strong> from Ferdio</p>
                    <p>Do you have a good story, a clear message and some data to support it? We’ll help you tell that story in the most convincing and memorable way ⚡️</p>
                </div>
        ...
        <h1 id="w-node-2a8cb55ea676-b55ea66f" class="margin-bottom-0">It's easy to get started</h1>
    </div>
</div>