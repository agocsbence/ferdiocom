...
//       hamburgerFixed = document.querySelector('#fixed-navigation .mobile-menu-wrapper'),
...
// hamburgerFixed.addEventListener('click', e => {
//     mobileMenu.classList.toggle('opened');
//     body.classList.toggle('lock-scroll');
//     console.log('hamburger clicked 🍔');
// });
...
// const construct = () => 
//     charming(text);
//     letters = Array.from(text.querySelectorAll('span'));
...
//     console.log(letters[2].innerHTML);
//     console.log(letters[3].innerHTML);
//     console.log(letters[4].innerHTML);
//     console.log(letters[5].innerHTML);
//     console.log(letters[6].innerHTML);
